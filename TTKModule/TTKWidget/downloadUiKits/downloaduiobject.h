...
namespace TTK
{
    namespace UI
    {
        ...
        const QString ToolButtonStyle03 = ToolButtonStyle01 + ToolButtonStyle02 + " \
                QToolButton::hover{ background-color:rgba(255, 255, 255, 20);}";

        const QString ToolButtonStyle04 = ToolButtonStyle01 + " \
                QToolButton::menu-indicator{ image:None;}";

        const QString ToolButtonStyle05 = " \
        ...
        const QString ScrollBarStyle02 = ScrollBarStyle01 + " \
