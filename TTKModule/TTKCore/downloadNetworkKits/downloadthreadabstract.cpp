...
void DownLoadThreadAbstract::updateDownloadSpeed()
{
    ...
    //////////////////////////////////////
    ///limit speed
    if(G_SETTING_PTR->value(DownloadSettingManager::Config::DownloadLimitChoiced).toInt() == 0)
    {
        const int limitValue = G_SETTING_PTR->value(DownloadSettingManager::Config::DownloadDLoadLimitChoiced).toInt();
